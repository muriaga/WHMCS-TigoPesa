...
* To get your API Key, Secret Key, Merchant MSISDN, Merchant PIN, Account ID, AccessToken URL, Payment URL and Validate MFS URL, Contact with Tigopesa Tech Support.
